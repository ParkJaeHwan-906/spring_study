...
public class QuizControllerTest {
    ...
    // 문제 1. GET 요청을 보내 응답 코드마다 예상하는 응답을 반환하는지 검증하는 테스트를 작성해라
    ...
    public void getQuiz1() throws Exception{
        ...
        //when
        // 쿼리 파라미터 추가 방법은 perform 메서드에 param 메서드 체이닝하여 사용
    ...
    // 문제 2. POST 요청을 보내 응답 코드마다 예상하는 응답을 반환하는지 검증하는 테스트 코드를 작성해라
